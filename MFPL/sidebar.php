...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <?php
        //echo basename(__FILE__);
        $vals = array('tcp_report','recipe_count_report','rcbrandwise','most_selling_recipe', 'live_machine_report', 'dead_machines_report', 'category_count', 'error_count', 'maintainance_report', 'failure_count','recipe_process');
